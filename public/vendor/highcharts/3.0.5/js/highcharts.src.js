 ...
 */
function format_highcharts(str, ctx) {
	var splitter = '{',
		isInside = false,
		segment,
		valueAndFormat,
		...
		val,
		index;
	if(typeof str === 'function') str = String(str());
...
Axis.prototype = {
	...
	defaultLabelFormatter: function () {
		...
		if (formatOption) {
			ret = format_highcharts(formatOption, this);
	...
	renderItem: function (item) {
		...
		if (!li) { // generate it once, later move it
			...
			item.legendItem = li = renderer.text(
					options.labelFormat ? format_highcharts(options.labelFormat, item) : options.labelFormatter.call(item),
...
Point.prototype = {
	...
	tooltipFormatter: function (pointFormat) {
		...
		return format_highcharts(pointFormat, {
			point: this,
			series: this.series
		});
	},
...
Series.prototype = {
	...
	tooltipHeaderFormatter: function (point) {
		...
		return format_highcharts(headerFormat, {
			point: point,
			series: series
		});
	},
